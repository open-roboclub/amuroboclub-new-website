...
//                                 <h3 className="card-title" title={item.name} style={{textOverflow: "ellipsis", overflow: "hidden", whiteSpace:"nowrap", width:"250px"}}>{item.name} by {item.author} </h3>
//                                  <p className="card-text"></p>
//                                   <button class="btn btn-primary btn-dark" data-backdrop="true" data-toggle="modal"  data-target="#exampleModalLong"
//                                   onClick={()=>getData(item.projectImg[1], item.name, item.description, item.progress, item.teamMembers, item.date)}>Read Blog
//                                  </button>
//                                   </div>
//                                   {/* {
//                                      item.progress === "100"? <>
