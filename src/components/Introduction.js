                ...
                <div className="col-md-6 layout_padding_2">
                    <div className="full">
                        <div className="heading_main text_align_center">
						  ...
						  <p style={{color:"#E5E4E2", textAlign: "justify", fontSize:"15px"}}>{content[0].about}</p>
						
                    </div>
                </div>
				<div className="col-md-6">
                    <div className="full" style={{marginTop: "80px"}}>
                        <img style={{height:"340px", borderRadius:"40px", userSelect: "none"}} src={content[0].aboutImages[0].image} alt="#" />
                    </div>
                </div>
            </div>
        </div>
